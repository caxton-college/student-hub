		...
		for user in tqdm(users):
			...
			<html>
			  <body>
				...
				<p>We hope it imporves school and allows you to win prizes. Note that the app will only be accessible when connected to the school Wi-Fi.</p>
				<p>Best regards,<br/>Carlos Lorenzo on behalf of Caxton College</p>
			  </body>
			</html>
			"""         
...
def populate_db() -> None:
	...
	for i, row in tqdm(df.iterrows()):
		try:
			...
			print(e)
			print(f"{i}. Failed to create user {row['email']}")
			continue
