...
urlpatterns = [
    ...
    path("activate_suggestion", views.ActivateSuggestion.as_view(), name="activatesuggestion"),
    path("reject_suggestion", views.RejectSuggestion.as_view(), name="activatesuggestion"),
